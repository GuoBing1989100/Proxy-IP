// 配置文件
const config = {
    // 数据源URL - 从同域名下的Data文件夹读取（适用于Cloudflare Pages）
    dataUrl: './Data/alive.txt',
    
    // GitHub备用数据源（如果本地加载失败）
    fallbackDataUrl: 'https://raw.githubusercontent.com/GuoBing1989100/ProxyIP/main/Data/alive.txt',
